...
class ApiEndpoint {
  ...
  static String auth(AuthEndpoint endpoint) {
    ...
    switch (endpoint) {
      ...
      case AuthEndpoint.IDENTITY: return '$path/identity';
      case AuthEndpoint.REFERRAL_CODE: return '$path/referralCode';
      case AuthEndpoint.VERIFY_OTP: return '$path/verifyOtp';
    }
  }
