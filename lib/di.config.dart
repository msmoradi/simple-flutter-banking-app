...
import 'package:banx/di.dart' as _i31;
...
import 'package:banx/feature/phone/presentation/bloc/phone_bloc.dart' as _i30;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i26.VerifyPasswordBloc>(() => _i26.VerifyPasswordBloc(
          authenticationRepository: gh<_i22.AuthenticationRepository>(),
          tokenRepository: gh<_i9.TokenRepository>(),
          profileRepository: gh<_i20.ProfileRepository>(),
    ...
    gh.factory<_i27.VerifyOtpBloc>(() => _i27.VerifyOtpBloc(
        authenticationRepository: gh<_i22.AuthenticationRepository>()));
    gh.factory<_i28.IdentityBloc>(() => _i28.IdentityBloc(
        authenticationRepository: gh<_i22.AuthenticationRepository>()));
    gh.factory<_i29.CardOrderBloc>(() => _i29.CardOrderBloc(
        authenticationRepository: gh<_i22.AuthenticationRepository>()));
    gh.factory<_i30.PhoneBloc>(() => _i30.PhoneBloc(
        authenticationRepository: gh<_i22.AuthenticationRepository>()));
    return this;
  }
}
